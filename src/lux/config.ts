...
export const LUX_CONFIG = {
  ...
  bloom: 0.5,         // интенсивность общего Bloom (свечение ярких зон поверх кадра)
  contrast: 1.08,     // контраст фигуры вокруг средне-серого (1.0 = без изменения)
  temp: 0.02,         // температура фигуры: тёплый(+)/холодный(−) сдвиг R↔B
